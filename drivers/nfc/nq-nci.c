...
int nfc_ioctl_power_states(struct file *filp, unsigned long arg)
{
	...
	if (arg == 0) {
		 ...
		 * layers.
		 */
		//nqx_disable_irq(nqx_dev); // MODIFIED by na.long, 2017-05-15,BUG-4406059
		dev_dbg(&nqx_dev->client->dev,
				...
				unsigned long arg)
{
	...
	default:
#ifdef BBRY_ANDROID
		dev_err(pfile->private_data->client->dev, "Unknown compat_ioctl cmd: 0x%08x", cmd);
#endif
		r = -ENOTTY;
	}
	return r;
			...
			unsigned long arg)
{
	...
	default:
#ifdef BBRY_ANDROID
		dev_err(pfile->private_data->client->dev, "Unknown ioctl cmd: 0x%08x", cmd);
#endif
		r = -ENOIOCTLCMD;
	}
	return r;
...
#ifdef CONFIG_NFC_HW_CHECK // MODIFIED by Ji.Chen, 2016-11-11,BUG-3374025
...
#endif // MODIFIED by Ji.Chen, 2016-11-11,BUG-3374025
			...
			const struct i2c_device_id *id)
{
	...
	nqx_dev->nqx_device.name = "nq-nci";    //Modify by TCTNB.Ji.Chen, 2017/10/17,PR-5413871
	...
	if (r) {
		...
		*/
/* MODIFIED-BEGIN by Ji.Chen, 2016-11-11,BUG-3374025*/
#ifdef CONFIG_NFC_HW_CHECK
		goto err_request_hw_check_failed;
#else
        goto err_request_irq_failed;
#endif
/* MODIFIED-END by Ji.Chen,BUG-3374025*/
	}
