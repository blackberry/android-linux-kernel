...
#define OV8858_IDOL4S_CN_CMCC_OTP_DEBUG_ON 0
...
void ov8858_idol4s_cn_check_otp_info(void);
...
// read otp into buffer
	...
	printk("ov8858 module flag = 0x%x\n",flag);
//select group
	if (index == 1)
	{
		flag = (flag>>6) & 0x03;
...
#if OV8858_IDOL4S_CN_CMCC_OTP_DEBUG_ON
...
//		 1, no OTP
static int ov8858_idol4s_cn_wb_once, ov8858_idol4s_cn_lenc_once;
int ov8858_idol4s_cn_update_otp_wb(struct msm_camera_i2c_client *i2c_client)
{
	...
	//printk("reading 8858 otp info\n");
     // ov8858_idol4s_cn_check_otp_info();
	if (0 == ov8858_idol4s_cn_wb_once) {
		...
		ov8858_idol4s_cn_wb_once = 1;
	}

	if (1 == ov8858_idol4s_cn_wb_once) {
...
int ov8858_idol4s_cn_update_otp_lenc(struct msm_camera_i2c_client *i2c_client)
{
	...
	ov8858_g_client = i2c_client;
	if (0 == ov8858_idol4s_cn_lenc_once) {
		...
		ov8858_idol4s_cn_lenc_once = 1;
	}

	if (ov8858_idol4s_cn_lenc_once)
