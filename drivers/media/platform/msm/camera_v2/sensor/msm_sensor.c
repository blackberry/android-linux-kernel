...
/*Porting from idol4s_8976 jianqiang.chen@tcl.com ov8858 idol4s otp*/
#define TCT_SENSOR_OTP_OPEN     1
#if TCT_SENSOR_OTP_OPEN
#include "ov8858_idol4s_cn_v4l2_tct_OTP.h"
#include "Qtech_s5k4h8_idol4s.h"
#endif
/*Porting from idol4s_8976 jianqiang.chen@tcl.com ov8858 idol4s otp*/
#undef CDBG
...
/*Porting from idol4s_jianqiang.chen@tcl.com*/
    printk("%s, OTP: sensor name: %s\n", __func__, s_ctrl->sensordata->sensor_name);
    if ((!strcmp(s_ctrl->sensordata->sensor_name, "ov8858"))) {
        printk("OTP: %s update\n",s_ctrl->sensordata->sensor_name);
        ov8858_idol4s_cn_update_otp_wb(s_ctrl->sensor_i2c_client);
        ov8858_idol4s_cn_update_otp_lenc(s_ctrl->sensor_i2c_client);
    }else if(!strcmp(s_ctrl->sensordata->sensor_name, "s5k4h8_idol4pro_cn")){
        printk("OTP: %s update\n",s_ctrl->sensordata->sensor_name);
			...
			unsigned int cmd, void *arg)
{
	...
	case MSM_SD_NOTIFY_FREEZE:
		return 0;
/*Porting from idol4s 8976 jianqiang.chen@tcl.com ov8858 idol4s otp*/
