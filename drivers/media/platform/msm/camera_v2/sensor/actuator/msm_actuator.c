...
static int32_t msm_actuator_park_lens(struct msm_actuator_ctrl_t *a_ctrl)
{
	...
	struct msm_camera_i2c_reg_setting reg_setting;
	const uint16_t DEST_LENS_POS = 512; // MODIFIED by XuNan, 2017-05-19,BUG-4823685
	a_ctrl->i2c_tbl_index = 0;
	...
	/* MODIFIED-BEGIN by XuNan, 2017-05-19,BUG-4823685*/
	while (next_lens_pos != DEST_LENS_POS) {
		if(next_lens_pos > DEST_LENS_POS){
			...
			/* MODIFIED-END by XuNan,BUG-4823685*/
		}
		a_ctrl->func_tbl->actuator_parse_i2c_params(a_ctrl,
