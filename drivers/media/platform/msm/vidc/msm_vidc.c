...
/*[Defect]-Add-BEGIN by TCTSH.Cedar, 2016/06/23, qcom patch: avoid escalation of priviledge and crash*/
...
/*[Defect]-Add-END by TCTSH.Cedar, 2016/06/23, qcom patch: avoid escalation of priviledge and crash*/

int msm_vidc_prepare_buf(void *instance, struct v4l2_buffer *b)
{
	struct msm_vidc_inst *inst = instance;

	/*[Defect]-MODIFIED-BEGIN by TCTSH.Cedar, 2016/06/23, qcom patch: avoid escalation of priviledge and crash*/
	if (!inst || !b || !valid_v4l2_buffer(b, inst))
		return -EINVAL;
	/*[Defect]-MODIFIED-END   by TCTSH.Cedar, 2016/06/23, qcom patch: avoid escalation of priviledge and crash*/
