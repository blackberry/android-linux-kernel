...
#define MIN_NUM_OUTPUT_BUFFERS_HEVC 5 // MODIFIED by hanling.zhang, 2018-08-30,BUG-6924849
	...
	case V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE:
		*num_planes = inst->prop.num_planes[OUTPUT_PORT];
		...
		if (inst->fmts[OUTPUT_PORT].fourcc ==
			...
			*num_buffers = MIN_NUM_OUTPUT_BUFFERS_VP9;
		/* MODIFIED-BEGIN by hanling.zhang, 2018-08-30,BUG-6924849*/
		else if (inst->fmts[OUTPUT_PORT].fourcc ==
				V4L2_PIX_FMT_HEVC &&
				*num_buffers < MIN_NUM_OUTPUT_BUFFERS_HEVC)
			*num_buffers = MIN_NUM_OUTPUT_BUFFERS_HEVC;
			/* MODIFIED-END by hanling.zhang,BUG-6924849*/
