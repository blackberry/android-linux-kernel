...
int msm_vdec_g_fmt(struct msm_vidc_inst *inst, struct v4l2_format *f)
{
	...
	if (f->type == V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE) {
		...
		f->fmt.pix_mp.plane_fmt[0].sizeimage =
			/* MODIFIED-BEGIN by Qiancheng.Zhao, 2016-10-28,BUG-2896318*/
			fmt->get_frame_size(0,
			f->fmt.pix_mp.height, f->fmt.pix_mp.width);
			/* MODIFIED-END by Qiancheng.Zhao,BUG-2896318*/
				...
				void *alloc_ctxs[])
{
	...
	case V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE:
		...
		*num_buffers = clamp_val(*num_buffers,
		...
		sizes[0] = inst->bufq[CAPTURE_PORT].vb2_bufq.plane_sizes[0]; // MODIFIED by Qiancheng.Zhao, 2016-10-28,BUG-2896318
...
exit: // MODIFIED by Qiancheng.Zhao, 2016-10-28,BUG-2896318
	return rc;
}
