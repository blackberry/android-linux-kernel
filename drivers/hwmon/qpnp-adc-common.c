...
#ifdef CONFIG_BBRY
/* Voltage to temperature */
static const struct qpnp_vadc_map_pt adcmap_100k_104ef_104fb_bbry[] = {
	{1760,	-40009},
	{1750,	-36814},
	{1742,	-34597},
	{1731,	-31967},
...
#ifdef CONFIG_BBRY
	qpnp_adc_map_voltage_temp(adcmap_100k_104ef_104fb_bbry,
		ARRAY_SIZE(adcmap_100k_104ef_104fb_bbry),
...
#ifdef CONFIG_BBRY
		/* This will add an optional secondary scaling function */
		int sec_scaling = SCALE_NONE;
#endif
...
#ifdef CONFIG_BBRY
			rc = of_property_read_u32(child,
				"qcom,sec-scale-function", &sec_scaling);
			if (rc)
				sec_scaling = SCALE_NONE;
#endif
...
#ifdef CONFIG_BBRY
			adc_channel_list[i].adc_sec_scale_fn = sec_scaling;
#endif
