...
/*0x10A1, 0x03, default as 192 mins */
#define CHGR_PRE_CHARGE_SAFETY_TIMER_CFG (CHGR_BASE + 0xA1)
#define PRE_CHARGE_SAFETY_TIMER_MASK		GENMASK(1, 0)

/*0x10A2, 0x03, default as 1536 mins */
#define CHGR_FAST_CHARGE_SAFETY_TIMER_CFG (CHGR_BASE + 0xA2)
...
#if defined(CONFIG_TCT_SDM660_COMMON)
#define OTG_HICCUP_CFG_REG		(OTG_BASE + 0xE2)
#define OTG_HICCUP_DISABLE	(0x01)
#endif
