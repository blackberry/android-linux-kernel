...
static struct smb_params v1_params = {
	.fcc			= {
/* MODIFIED-BEGIN by jin.wang, 2017-12-28,BUG-5828014*/
#if defined(CONFIG_TCT_SDM660_COMMON)
		.name	= "FCC",
#else
...
#endif
/* MODIFIED-END by jin.wang,BUG-5828014*/
...
static enum power_supply_property smb2_batt_props[] = {
	...
	POWER_SUPPLY_PROP_USB_OTG, // MODIFIED by jin.wang, 2017-12-28,BUG-5828014
#endif
};
...
#if defined(CONFIG_TCT_SDM660_COMMON)
	case POWER_SUPPLY_PROP_CHARGING_ENABLED:
	case POWER_SUPPLY_PROP_CONSTANT_CHARGE_CURRENT_MAX: // MODIFIED by jin.wang, 2017-12-28,BUG-5828014
	case POWER_SUPPLY_PROP_SET_SHIP_MODE:
#endif
		return 1;
	default:
...
#if defined(CONFIG_TCT_SDM660_COMMON)
	/* during power on, the ICL must be limited. */
	smblib_set_charge_param(chg, &chg->param.usb_icl, 100000);

	if (smblib_icl_override(chg, true) < 0) {
#else
