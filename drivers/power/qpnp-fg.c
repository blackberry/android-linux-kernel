...
static void fg_cap_learning_work(struct work_struct *work)
{
	...
	/* MODIFIED-BEGIN by jin.wang, 2016-04-27,BUG-2003077*/
	if (chip->wa_flag & USE_CC_SOC_REG)
		goto fail;
		/* MODIFIED-END by jin.wang,BUG-2003077*/
...
#if defined(CONFIG_TCT_8X76_COMMON)//[FEATURE] MODIFY-BY-SUN ZHANGYANG,2016.04.05, DEFECT1910727
	case POWER_SUPPLY_PROP_UPDATE_NOW:
		return 1;
#endif
...
static int fg_common_hw_init(struct fg_chip *chip)
{
	int rc;
	int resume_soc_raw;
	u8 val = 0; // MODIFIED by jin.wang, 2016-04-22,BUG-1929920
