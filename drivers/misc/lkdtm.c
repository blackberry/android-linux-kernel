...
static void lkdtm_do_action(enum ctype which)
{
	...
	case CT_WRAP_ATOMIC: {
		...
		pr_info("attempting atomic overflow 64bit\n");
		atomic64_inc(&over64);
		atomic64_inc_return(&over64);

		pr_info("attempting atomic underflow 64bit\n");
