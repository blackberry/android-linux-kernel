...
#define DWC3_CHG_DCD_MAX_RETRIES	3 /* Tdcd_tmout = 3 * 300 msec */
#define DWC3_CHG_PRIMARY_DET_TIME	(150 * HZ/1000) /* TVDPSRC_ON */
#define DWC3_CHG_SECONDARY_DET_TIME	(150 * HZ/1000) /* TVDMSRC_ON */
#else
