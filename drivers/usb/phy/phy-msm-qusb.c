...
/*TCTNB.YQJ modified begin for eye diagram performance, task-1496875, 2016/01/25 */
#if defined(CONFIG_TCT_8996_IDOL4S_CN)
	writel_relaxed(0xA0, qphy->base + QUSB2PHY_PORT_TUNE1);
	writel_relaxed(0x85, qphy->base + QUSB2PHY_PORT_TUNE2);
	writel_relaxed(0x81, qphy->base + QUSB2PHY_PORT_TUNE3);
	writel_relaxed(0x87, qphy->base + QUSB2PHY_PORT_TUNE4);
#endif
