...
extern unsigned usb_mode;
module_param(enable_l1_for_hs, bool, S_IRUGO | S_IWUSR);
module_param(usb_mode, uint, S_IRUGO);
...
/*Modify Begin by TCTNB.YQJ, 2017-01-18,task-4040338*/
#if defined(CONFIG_BBRY)
	usb_ext->bmAttributes = cpu_to_le32(USB_LPM_SUPPORT|USB_BESL_SUPPORT);
#else
	usb_ext->bmAttributes = cpu_to_le32(USB_LPM_SUPPORT);
#endif
/*Modify End by TCTNB.YQJ, task-4040338*/
	...
	case USB_REQ_GET_DESCRIPTOR:
		...
		case USB_DT_DEVICE:
			...
			if (gadget_is_superspeed(gadget)) {
				if (gadget->speed >= USB_SPEED_SUPER) {
/*Modify Begin by TCTNB.YQJ, 2016-12-30,task-3880007*/
#if defined(CONFIG_BBRY)
					cdev->desc.bcdUSB = cpu_to_le16(0x0310);
#else
					cdev->desc.bcdUSB = cpu_to_le16(0x0300);
#endif
/*Modify End by TCTNB.YQJ, task-3880007*/
