...
#ifdef CONFIG_BBRY
/*[Defect]-Add-BEGIN by TCTSH.Cedar, 2222968, 2016/06/23, required min duration is 50ms*/
#define QPNP_HAP_TIMEOUT_MS_MIN		40  /* 50ms is too much for Argon */
/*[Defect]-Add-END   by TCTSH.Cedar, 2222968, 2016/06/23, required min duration is 50ms*/
#endif // CONFIG_BBRY
...
#ifdef CONFIG_BBRY
		pr_err("Vibration req:  %d ms\n", value );
		/*[Defect]-Add-BEGIN by TCTSH.Cedar, 2222968, 2016/06/23, required min duration is 50ms*/
		value = (value < QPNP_HAP_TIMEOUT_MS_MIN ?
				 QPNP_HAP_TIMEOUT_MS_MIN : value);
		/*[Defect]-Add-END   by TCTSH.Cedar, 2222968, 2016/06/23, required min duration is 50ms*/
		pr_err("Vibration used: %d ms\n", value );
#endif // CONFIG_BBRY
		hap->state = 1;
