	...
	struct wan_ioctl_set_tether_client_pipe *data)
{
    ...
    //Added-begin by Alan.Tan for defect 4244393 on February 17th,2017.
    ...
    if (data->ul_src_pipe_len > QMI_IPA_MAX_PIPES_V01 ||
        ...
        data->ul_src_pipe_len, QMI_IPA_MAX_PIPES_V01);
           return -EFAULT;
    }
    ...
    //Added-end by Alan.Tan for defect 4244393 on February 17th,2017.
