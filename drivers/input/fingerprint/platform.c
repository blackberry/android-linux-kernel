...
int gf_hw_reset(struct gf_dev *gf_dev, unsigned int delay_ms)
{
    ...
    gpio_direction_output(gf_dev->reset_gpio, 0); // MODIFIED by Ji.Chen, 2018-04-28,BUG-6274386
    gpio_set_value(gf_dev->reset_gpio, 0);
    mdelay(3);
