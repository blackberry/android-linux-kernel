...
//for(i2c_addr_try =0;i2c_addr_try<0xff;i2c_addr_try++)
{
	//rmi4_data->hw_if->board_data->i2c_addr = i2c_addr_try;
...
pr_err("synaptics_rmi4_probe   ====0.1\n");
...
pr_err("synaptics_rmi4_probe   ====0.2\n");
