...
pr_err("synaptics_rmi4_i2c_probe   ===1 \n");
...
pr_err("synaptics_rmi4_i2c_probe   ===2 \n");
#ifdef CONFIG_OF
...
#endif
pr_err("^^^^^^^^^^^^^ synaptics_rmi4_i2c_probe  client->addr =  %x \n",client->addr);
...
pr_err("synaptics_rmi4_i2c_probe   ===4 \n");
...
pr_err("synaptics_rmi4_i2c_probe   ===5 \n");
	return 0;
}
