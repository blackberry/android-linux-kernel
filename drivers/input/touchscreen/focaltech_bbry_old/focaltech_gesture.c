...
*******************************************************************************/
#define FTS_GESTURE_INFO  "Gesture_Version  V1.0.1 2016-02-16"
...
/*******************************************************************************
*  Name: fts_report_key_down_up
*  Brief:	frank
*  Input:
*  Output: None
*  Return: None
*******************************************************************************/
static void fts_report_key_down_up(struct input_dev *input_dev, unsigned int code)
{
...
/*******************************************************************************
*   Name: fts_report_gesture
*  Brief:
*  Input:
* Output: None
* Return: None
*******************************************************************************/
static void fts_report_gesture(struct input_dev *input_dev,int gesture_id)
{
	...
	{
		case GESTURE_LEFT:
			fts_report_key_down_up(input_dev, KEY_GESTURE_LEFT);
			break;
		case GESTURE_RIGHT:
			fts_report_key_down_up(input_dev, KEY_GESTURE_RIGHT);
			break;
		case GESTURE_UP:
			fts_report_key_down_up(input_dev, KEY_GESTURE_UP);
			break;
		case GESTURE_DOWN:
			fts_report_key_down_up(input_dev, KEY_GESTURE_DOWN);
			break;
		case GESTURE_DOUBLECLICK:
			fts_report_key_down_up(input_dev, KEY_GESTURE_U);
			break;
		case GESTURE_O:
			fts_report_key_down_up(input_dev, KEY_GESTURE_O);
			break;
		case GESTURE_W:
			fts_report_key_down_up(input_dev, KEY_GESTURE_W);
			break;
		case GESTURE_M:
			fts_report_key_down_up(input_dev, KEY_GESTURE_M);
			break;
		case GESTURE_E:
			fts_report_key_down_up(input_dev, KEY_GESTURE_E);
			break;
		case GESTURE_L:
			fts_report_key_down_up(input_dev, KEY_GESTURE_L);
			break;
		case GESTURE_S:
			fts_report_key_down_up(input_dev, KEY_GESTURE_S);
			break;
		case GESTURE_V:
			fts_report_key_down_up(input_dev, KEY_GESTURE_V);
			break;
		case GESTURE_Z:
			fts_report_key_down_up(input_dev, KEY_GESTURE_Z);
			break;
		default:
			break;
	}
...
int fts_read_Gestruedata(void)
{
    ...
    /* FW */
	 ...
	 if (ret < 0)
	 {
		...
		fts_report_gesture(fts_input_dev,gestrue_id);
