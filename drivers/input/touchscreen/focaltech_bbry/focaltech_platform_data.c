...
static int fts_platform_data_regulator_release(struct fts_ts_platform_data * pdata);
...
int fts_platform_data_exit(void)
{
	...
	fts_platform_data_regulator_release(fts_platform_data);
...
/*******************************************************************************
*  Name: fts_platform_data_regulator_release
*  Brief: free regulator
*  Input:
*  Output:
*  Return:
*******************************************************************************/
...
{
	if (pdata->disp_1p8)
		regulator_put(pdata->disp_1p8);

	if (pdata->disp_n5v)
		regulator_put(pdata->disp_n5v);

	if (pdata->disp_p5v)
		regulator_put(pdata->disp_p5v);
