...
#define FTS_BUFFER_I_FILE_1  "i_file1/FT8707_FW_BOE_4p5inch_BlackBerry_ATHENA_V0xA5_D0x05_20180409_all.i"
...
static void fts_flash_get_upgrade_info(void)
{
	...
	{
		/*Èç¹û´Ó¼Ä´æÆ÷¶Á²»µ½£¬Ôò¸ù¾ÝÉèÖÃµÄIC NAMEÀ´ÉèÖÃUpgrade Info*/
...
static int fts_flash_compare_chip_id(unsigned char chip_id, unsigned char chip_id2)
{
	int i = 0;
	int index = -1;
	/*IDCÐ¾Æ¬ÐèÒªÁ½¸öid²ÅÄÜÇø·Ö¿ªÐ¾Æ¬£¬ËùÒÔÒª·Ö¿ª±È½Ï*/
	if(fts_ic_table_need_chip_id2(chip_id) < 0)/*²»ÐèÒªchip_id2*/
	{
