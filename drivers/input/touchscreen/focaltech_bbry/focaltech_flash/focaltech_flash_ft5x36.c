...
*******************************************************************************/
#define FOCALTECH_FLASH_FT5X36_INFO  "File Version of  focaltech_flash_ft5x36.c:  V1.0.0 2016-03-21"
	...
	for (i = 0; i < FTS_UPGRADE_LOOP; i++) 
{
		...
		auc_i2c_write_buf[1] = auc_i2c_write_buf[2] = auc_i2c_write_buf[3] = 0x00;
              ...
              {
                      FTS_COMMON_DBG( "[FTS] Step 3: CTPM ID FAILD,ID1 = 0x%x,ID2 = 0x%x", reg_val[0],reg_val[1]);
                      continue;
              }
