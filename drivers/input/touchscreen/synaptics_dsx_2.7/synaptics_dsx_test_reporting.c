...
/* MODIFIED-BEGIN by Haojun Chen, 2017-07-31,BUG-5112790*/
	...
	if (rmi4_data->external_afe_buttons)
		f54->tx_assigned++;
#endif
/* MODIFIED-END by Haojun Chen,BUG-5112790*/
...
/* MODIFIED-BEGIN by Haojun Chen, 2017-08-16,BUG-5189930*/
#ifdef CONFIG_KRYPTON
	f54->tx_assigned++;
#else
	if (rmi4_data->external_afe_buttons)
		f54->tx_assigned++;
#endif
/* MODIFIED-END by Haojun Chen,BUG-5189930*/
