				...
				struct synaptics_dsx_board_data *bdata)
{
	...
	bdata->power_gpio1 = of_get_named_gpio_flags(np, "synaptics,power-gpio1", 0, NULL);
	bdata->power_gpio2 = of_get_named_gpio_flags(np, "synaptics,power-gpio2", 0, NULL);
	bdata->power_gpio3 = of_get_named_gpio_flags(np, "synaptics,power-gpio3", 0, NULL);
