...
#undef CONFIG_BBRY_DEBUG
#undef CONFIG_BBRY_MFG
#define CONFIG_BBRY_DEBUG  1
#define CONFIG_BBRY_MFG    1
 ...
 */
#define SYNAPTICS_STATS_PERIOD  3000	/* 5000 ms period */
...
#define RESUME_IGNORE_TOUCH_DELAY (1000)	/*msec*/
...
struct synaptics_rmi4_data {
	...
	struct delayed_work force_cal_work;
...
void synaptics_bbryrmi4_glass_on_notif(bool glass_off);
