...
{
	ssize_t retval;
	unsigned char *tmpbuf; // MODIFIED by mengjie.liu, 2016-08-09,BUG-2515520
	struct rmidev_data *dev_data = filp->private_data;
	...
	/* MODIFIED-BEGIN by mengjie.liu, 2016-08-09,BUG-2515520*/
...
clean_up:
	...
	kfree(tmpbuf); // MODIFIED by mengjie.liu, 2016-08-09,BUG-2515520
	return retval;
}
