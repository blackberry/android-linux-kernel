...
#ifdef CONFIG_BBRY
#define X_AXIS_MAX_FHD                      1065
#define X_AXIS_MIN                          15
#else
...
struct fts_stats {
    ...
    struct fts_stats_entry list[STATS_SIZE];
    struct work_struct timeout_work;
};

struct fts_mtouch_counter {
...
struct fts_ts_info {
...
#ifdef CONFIG_BBRY
        struct work_struct        backlight_on_work;
        struct workqueue_struct *stats_workqueue;
#endif
        ...
        unsigned long doubleclick_time;
        unsigned long doubleclick_time_store;
        unsigned long dtwakeup_complete_time;
        unsigned long backlight_on_time;
        struct fts_stats stats;
        struct fts_mtouch_counter mtouch_counter;
#endif
