...
int rndis_ipa_init(struct ipa_usb_init_params *params)
{
	...
	spin_lock_init(&rndis_ipa_ctx->state_lock); // MODIFIED by jin.wang, 2016-07-11,BUG-2114263
			...
			void *private)
{
	...
	unsigned long flags; // MODIFIED by jin.wang, 2016-07-11,BUG-2114263
	...
	/* MODIFIED-BEGIN by jin.wang, 2016-07-11,BUG-2114263*/
	...
	spin_unlock_irqrestore(&rndis_ipa_ctx->state_lock, flags);
	/* MODIFIED-END by jin.wang,BUG-2114263*/
