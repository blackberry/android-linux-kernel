...
#else
#define WL_AUTO_ROAM_TRIGGER -73 /* JI793830: default auto roam trigger for blackberry device */
#endif
/* hooks for custom Roaming Trigger  setting via Makefile */
#ifndef CONFIG_BBRY
#define DEFAULT_ROAM_TRIGGER_VALUE -75 /* dBm default roam trigger all band */
#else
#define DEFAULT_ROAM_TRIGGER_VALUE -73 /* JI793830: default roam trigger for blackberry device */
#endif
