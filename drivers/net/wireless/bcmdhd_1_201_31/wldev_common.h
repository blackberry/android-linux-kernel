...
#ifdef CONFIG_BBRY
extern int net_os_set_bus_idle(struct net_device *dev, bool allow);
extern int net_os_block_bus_idle(struct net_device *dev, bool block);
extern int net_os_set_bus_idle_feature_enabled(struct net_device *dev, bool enable);
extern bool net_os_get_bus_idle_feature_enabled(struct net_device *dev);
#endif /* CONFIG_BBRY */
