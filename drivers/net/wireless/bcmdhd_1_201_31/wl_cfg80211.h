...
#ifdef CONFIG_BBRY
/**
 * A wrapper function of kernel's regulatory_hint_user() in reg.c
 * which updates the regulatory domain infrastructure with a
 * new country code
 **/
extern void wl_give_regulatory_hint(const char *alpha2);
#endif /* CONFIG_BBRY */
