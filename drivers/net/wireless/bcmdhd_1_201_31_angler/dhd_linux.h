...
#ifdef CONFIG_BBRY
int pcie_schedule_bus_idle_suspend(struct dhd_info *dhd_info, bool suspend, bool high_priority);
int dhd_get_interrupt_source(void);
#endif /* CONFIG_BBRY */
