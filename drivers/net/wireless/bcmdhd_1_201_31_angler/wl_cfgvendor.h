...
#ifdef CONFIG_BBRY
	/* NOTE - needs to align with bbry_vndr_ext.cpp */
	BBRY_SUBCMD_GET_FW_VERSION = ANDROID_NL80211_SUBCMD_BBRY_RANGE_START,
	BBRY_SUBCMD_GET_MACMODE,
	BBRY_SUBCMD_SET_MACMODE,
	BBRY_SUBCMD_SET_MACLIST,
	BBRY_SUBCMD_SET_APSD,
#endif /* CONFIG_BBRY */
...
#ifdef CONFIG_BBRY
enum bbry_attributes {
	/* NOTE - needs to align with bbry_vndr_ext.cpp */
	BBRY_ATTRIBUTE_MACMODE = 0,
	BBRY_ATTRIBUTE_MACLIST_FLUSH,
	BBRY_ATTRIBUTE_MACLIST_BSSID,
	BBRY_ATTRIBUTE_CMD_INTERFACE,
	BBRY_ATTRIBUTE_APSD_ENABLE,
