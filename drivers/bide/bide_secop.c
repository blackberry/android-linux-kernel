				 ...
				 int flags)
{
	...
	if (uid_eq(old->uid, SYSTEM_UID) &&
	    !uid_eq(new->uid, SYSTEM_UID))
	...
	if (groups_search(new->group_info, ROOT_GID) ||
	    groups_search(new->group_info, SYSTEM_GID)){
