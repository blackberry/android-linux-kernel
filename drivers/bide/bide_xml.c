...
static const char DEV_NAME_TAGS[]	= "<devname>%s</devname>";
static const char PID_TAGS[]		= "<pid>%d</pid>";
static const char NAME_TAGS[]		= "<name>%s</name>";
...
static const char PROPERTY_TAG[] 	= "<property name='%s' value='%s' />";
...
static const char PROCESS_SINGLE_TAG[]	= "<process pid='%d' ppid='%d' name='%s' />";
