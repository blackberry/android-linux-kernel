...
int xml_process_msg(char *buf, unsigned sz, struct task_struct *task);
...
#define AUTH_PERM_PRIVILEGED_GID	1
#define AUTH_PERM_SYSTEM_UID		2
#define AUTH_PERM_ZYGOTEMGR		4
#define AUTH_PERM_PRIVILEGED_LINEAGE	8
#define AUTH_PERM_PRIVELEGED_CHILDREN	16
#define AUTH_PERM_PRIVILEGED_ZYGOTE	32
#define AUTH_PERM_INSTALLD		64
