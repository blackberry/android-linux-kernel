...
#if !defined(CONFIG_CRYPTO) || defined(CONFIG_CRYPTO_MODULE) || !defined(CONFIG_CRYPTO_SHA512) || defined(CONFIG_CRYPTO_SHA512_MODULE)
#error "crypto and sha512 must be built into the kernel"
#endif
 ...
 * @param   ctx                 The crypto context that all functions need.
 *
 * @return  0                   No Errors.
 ...
 * NULL, the function will deallocate memory but will not generate a hash.
 *
 * @param   ctx                 The crypto context.
