		...
		struct adf_buffer_mapping *mapping)
{
	...
	/*[Defect]-Modified-BEGIN by TCTSH.Cedar, 2339817, 2016/06/14, Apply the official google 6.0.1 supplied patch ANDROID-28447556*/
	if (ret < 0) {
		adf_buffer_mapping_cleanup(mapping, buf);
		memset(mapping, 0, sizeof(*mapping));
	}
	/*[Defect]-Modified-END   by TCTSH.Cedar, 2339817, 2016/06/14, Apply the official google 6.0.1 supplied patch ANDROID-28447556*/
