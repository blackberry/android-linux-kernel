...
#include <linux/power_supply.h> //ADD by TCTNB.YQJ, 2016-11-22,task-3562699
...
#define SUP_VBUS_CTL	//ADD by TCTNB.YQJ, 2016-12-01,task-3562699
#define AUTO_RDO_ENABLE	//ADD by TCTNB.YQJ, 2016-12-05,task-3615608
#define SUP_TRY_SRC_SINK

/* [PLATFORM]-Add-BEGIN by TCTNB.WPL, 2016/04/16, PR-1804050, USB type C status detect interface */
#define CC1_EN 0x4
#define CC2_EN 0x40
#define CC1_OTG_EN 0x1
#define CC2_OTG_EN 0x10
#define CC_ERR 0xff
...
/**
 * @desc:   Enable or disable VCONN Power
 *
 * @param:  enable = 1 - enable VCONN Power, enable = 0 - disable VCONN Power
 *
 * @return:  none
 *
 */
