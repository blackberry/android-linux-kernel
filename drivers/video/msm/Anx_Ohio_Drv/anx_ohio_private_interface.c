...
/* [BUGFIX]-Add-BEGIN by TCTNB.WPL, 2016/06/22, task-2390356, porting from PR-2323905, resolve USB cable not detectted & can not charger issue */
	OhioWriteReg(AUTO_PD_MODE, OhioReadReg(AUTO_PD_MODE) | 0x01);
/* [BUGFIX]-Add-END by TCTNB.WPL, 2016/06/22 */
...
/* [BUGFIX]-Remove-BEGIN by TCTNB.WPL, 2016/06/22, task-2390356, porting from PR-2323905, resolve PD chager high voltage & crash issue */
//		if ((~INTR_MASK_SETTING) & intr_vector & RECEIVED_MSG)
//			polling_interface_msg(INTERACE_TIMEOUT_MS);
/* [BUGFIX]-Remove-END by TCTNB.WPL, 2016/06/22 */
