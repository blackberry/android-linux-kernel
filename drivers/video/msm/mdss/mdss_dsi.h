...
#ifdef CONFIG_BBRY
static inline bool mdss_dsi_cmp_panel_reg_masked(struct dsi_buf status_buf,
	u32 *status_val, u32 *mask, int i)
{
	return (status_buf.data[i] & mask[i]) == status_val[i];
}
#endif
#endif /* MDSS_DSI_H */
