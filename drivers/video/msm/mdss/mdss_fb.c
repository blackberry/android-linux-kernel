...
/* BBRY: We have changed the android backlight level to a range of 0 to 100,000.
*  Because of this increased range the MDSS_BRIGHT_TO_BL equation will overflow,
*  however this equation isn't needed since we want the android backlight value
*  in the driver, therefore simply pass that value along.
*/
#ifndef CONFIG_BBRY
