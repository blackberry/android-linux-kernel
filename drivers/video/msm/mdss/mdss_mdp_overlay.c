...
#ifndef CONFIG_BBRY
	/* Enable post-processing when partial updates are
	 * enabled for BlackBerry.
	 */
	...
	struct mdp_overlay_list *ovlist, struct mdp_overlay *ip_ovs)
{
	...
	/*
	* if user is doing prepare it means it no longer needs
	* pipe reserved for pan display
	*/
