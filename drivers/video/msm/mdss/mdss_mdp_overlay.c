...
#ifdef CONFIG_BBRY
	/* This maps lcd-backlight sysfs level (0 to panel_info->brightness_max) into
		driver backlight level 0 to bl_max with rounding */
	MDSS_BRIGHT_TO_BL(mfd->bl_min_lvl, data->min_lvl, mfd->panel_info->bl_max,
	...
	struct mdp_overlay *ovs, int num_ovs)
{
	...
	for (i = 0; i < num_ovs; i++) {
        /* SH-TCT-JHYU fix 2902854: sync CR1049232 09-13-2006 */
