...
pcc_clk_off:
		...
		if (pp_ops[PCC].pp_set_config) {
#ifdef CONFIG_BBRY
			struct mdp_pcc_data_v1_7 *pcc_data = (struct mdp_pcc_data_v1_7*) config->cfg_payload;
			pr_debug("version of pcc is %d\n", config->version);
			pr_debug("%d %d %d %d %d %d %d %d\n", pcc_data->r.c, pcc_data->r.r, pcc_data->r.g, pcc_data->r.b, pcc_data->r.rg, pcc_data->r.gb, pcc_data->r.rb, pcc_data->r.rgb);
			pr_debug("%d %d %d %d %d %d %d %d\n", pcc_data->g.c, pcc_data->g.r, pcc_data->g.g, pcc_data->g.b, pcc_data->g.rg, pcc_data->g.gb, pcc_data->g.rb, pcc_data->g.rgb);
			pr_debug("%d %d %d %d %d %d %d %d\n", pcc_data->b.c, pcc_data->b.r, pcc_data->b.g, pcc_data->b.b, pcc_data->b.rg, pcc_data->b.gb, pcc_data->b.rb, pcc_data->b.rgb);
#else
			pr_debug("version of pcc is %d\n", config->version);
#endif
			res_cache.block = DSPP;
...
static int pp_mfd_ad_release_all(struct msm_fb_data_type *mfd)
{
	...
	ad->state = 0;
	mutex_unlock(&ad->lock);
	cancel_work_sync(&ad->calc_work); // MODIFIED by Alvin Li, 2016-08-24,BUG-2791321
