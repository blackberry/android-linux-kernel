...
ssize_t get_emmc_health(struct mmc_host *host, char *buf, int len)
{
	...
	switch( host->card->cid.manfid) {
		case MID_MMC_TOSHIBA:
			size += snprintf(buf+strlen(buf), len - strlen(buf),"TOSHIBA HEALTH:\n");
			if ((toshiba_gen_cmd(host, TOSHIBA_DEVICE_HEALTH, TOSHIBA_DEVICE_HEALTH_PWD, dat)) == 0) {
				...
				size += snprintf(buf+strlen(buf), len - strlen(buf),"LIFE TIME TOTAL %d\n", dh.toshiba.lifetime_total);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"RESERVED BLOCKS %d\n", dh.toshiba.lifetime_rsvd_blk);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"AVERAGE PE %d\n", dh.toshiba.lifetime_avg_pe);
			}
			...
			if ((toshiba_gen_cmd(host, TOSHIBA_WRITE_ERASE_COUNT, TOSHIBA_WRITE_ERASE_COUNT_PWD, dat)) == 0) {
				...
				size += snprintf(buf+strlen(buf), len - strlen(buf),"SLC MAX PE %d\n", dh.toshiba.slc_max_pe);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"SLC AVERAGE PE %d\n", dh.toshiba.slc_avg_pe);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MLC MAX PE %d\n", dh.toshiba.mlc_max_pe);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MLC AVERAGE PE %d\n", dh.toshiba.mlc_avg_pe);
			}
			break;

		case MID_MMC_SANDISK:
		case MID_MMC_SANDISK_2:
			size += snprintf(buf+strlen(buf), len - strlen(buf),"SANDISK HEALTH:\n");
			if (mmc_send_ext_csd(host->card, dat) == 0)
			{
				...
				size += snprintf(buf+strlen(buf), len - strlen(buf),"LIFE TIME %d\n", dh.sandisk.lifetime);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"NV AVERAGE PE %d\n", dh.sandisk.nv_avg_pe);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"EUA AVERAGE PE %d\n", dh.sandisk.eua_avg_pe);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MLC AVERAGE PE %d\n", dh.sandisk.mlc_avg_pe);
			}
			break;

		case MID_MMC_SAMSUNG:
			size += snprintf(buf+strlen(buf), len - strlen(buf),"SAMSUNG:\n");
			if ((samsung_smart_report(host, dat)) == 0) {
				...
				size += snprintf(buf+strlen(buf), len - strlen(buf),"NUMBER OF BANKS %d\n", dh.samsung.num_banks);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK0 RESERVED BLOCKS %d\n", dh.samsung.bank0_rsvd_blocks);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK1 RESERVED BLOCKS %d\n", dh.samsung.bank1_rsvd_blocks);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK2 RESERVED BLOCKS %d\n", dh.samsung.bank2_rsvd_blocks);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK3 RESERVED BLOCKS %d\n", dh.samsung.bank3_rsvd_blocks);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"INIT BAD BLOCKS %d\n", dh.samsung.init_bad_blocks);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"RUNTIME BAD BLOCKS %d\n", dh.samsung.runtime_bad_blocks);

				size += snprintf(buf+strlen(buf), len - strlen(buf),"SLC MAX EC %d\n", dh.samsung.slc_max_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"SLC MIN EC %d\n", dh.samsung.slc_min_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"SLC AVERAGE EC %d\n", dh.samsung.slc_avg_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MLC MAX EC %d\n", dh.samsung.mlc_max_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MLC MIN EC %d\n", dh.samsung.mlc_min_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MLC AVERAGE EC %d\n", dh.samsung.mlc_avg_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MAX EC %d\n", dh.samsung.max_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"MIN EC %d\n", dh.samsung.min_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"AVERAGE EC %d\n", dh.samsung.avg_ec);
				size += snprintf(buf+strlen(buf), len - strlen(buf),"READ RECLAIM %d\n", dh.samsung.read_reclaim);
				...
				if (dh.samsung.num_banks > 4) {
					...
					size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK4 RESERVED BLOCKS %d\n", dh.samsung.bank4_rsvd_blocks);
					size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK5 RESERVED BLOCKS %d\n", dh.samsung.bank5_rsvd_blocks);
					size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK6 RESERVED BLOCKS %d\n", dh.samsung.bank6_rsvd_blocks);
					size += snprintf(buf+strlen(buf), len - strlen(buf),"BANK7 RESERVED BLOCKS %d\n", dh.samsung.bank7_rsvd_blocks);
					size += snprintf(buf+strlen(buf), len - strlen(buf),"INIT BAD BLOCKS %d\n", dh.samsung.init_bad_blocks);
					size += snprintf(buf+strlen(buf), len - strlen(buf),"RUNTIME BAD BLOCKS %d\n", dh.samsung.runtime_bad_blocks);
				}
			}
		...
		default:
			size += snprintf(buf+strlen(buf), len - strlen(buf),"un-supported eMMC\n");
			break;
	}
...
ssize_t get_emmc_simple_health(struct mmc_host *host, char *buf, int len)
{
	unsigned char *dat;
	ssize_t size = 0;
	int rc;
	...
	if (mmc_send_ext_csd(host->card, dat) == 0) {
		rc = snprintf(buf+size, len-size, "DEVICE_LIFE_TIME_EST_TYP_B=0x%02x\n", dat[269]);
		if (rc > 0 && rc < (len-size))
			size += rc;

		rc = snprintf(buf+size, len-size, "DEVICE_LIFE_TIME_EST_TYP_A=0x%02x\n", dat[268]);
		if (rc > 0 && rc < (len-size))
			size += rc;

		rc = snprintf(buf+size, len-size, "PRE_EOL_INFO=0x%02x\n", dat[267]);
		if (rc > 0 && rc < (len-size))
			size += rc;
	} else
		pr_err("%s unable to retrieve ext_csd information\n", __func__);

	kfree(dat);

	return size;
}
EXPORT_SYMBOL(get_emmc_simple_health);
