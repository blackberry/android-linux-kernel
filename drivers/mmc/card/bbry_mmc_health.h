...
extern ssize_t get_emmc_simple_health(struct mmc_host *host, char *buf, int len);

#ifdef CONFIG_BBRY_DEBUG
extern ssize_t get_emmc_health(struct mmc_host *host, char *buf, int len);
