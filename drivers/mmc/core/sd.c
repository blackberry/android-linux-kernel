...
/*[FEATURE]-ADD-BEGIN TCTNB.Yubin, 01/09/2017, make a module parameter for sd runtime suspend control*/
#include <linux/module.h>
#include <linux/of.h>
static int sd_runtime_suspend_en_ = 1;
module_param_named(sd_runtime_suspend_en, sd_runtime_suspend_en_, int, S_IRUSR | S_IWUSR);
...
/*[FEATURE]-ADD-BEGIN TCTNB.Yubin, 03/18/2016, make a module parameter for sd runtime suspend control*/
	if((sd_runtime_suspend_en_ == 0) && ((int)of_alias_get_id(host->parent->of_node, "sdhc") == 2))
		return 0;
/*[FEATURE]-ADD-END TCTNB.Yubin*/
