...
/* [PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2017/12/01, Add the SD-detection interface to MMISW */
...
/* [PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2017/12/01, Add the SD-detection interface to MMISW */
#ifdef CONFIG_TCT_SDM660_COMMON
static int detect_status;
module_param(detect_status, int, S_IRUGO);
#endif
/* [PLATFORM]-Add-END by TCTNB.YuBin */
...
/* [PLATFORM]-Add-BEGIN by TCTNB.YuBin, 2017/12/01, Add the SD-detection interface to MMISW */
#ifdef CONFIG_TCT_SDM660_COMMON
       detect_status = gpio_get_value(SD_DETECT);
#endif
/* [PLATFORM]-Add-END by TCTNB.YuBin */
