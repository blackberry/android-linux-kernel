...
static int sdhci_msm_probe(struct platform_device *pdev)
{
	...
	if (gpio_is_valid(msm_host->pdata->status_gpio)) {
		...
		sdhci_msm_setup_pins(msm_host->pdata, true);
               ...
               pinctrl_select_state(msm_host->pdata->pctrl_data->pctrl,msm_host->pdata->pctrl_data->pins_onetime); // MODIFIED by qiuwei, 2016-04-20,BUG-1965011
		/*
...
#if 0	//[PLATFORM]-MODIFIED by TCTNB.YQJ, 04/25/2016,defect-1629668, qcom-patch delete the pm interface of mmc for system resume speed
