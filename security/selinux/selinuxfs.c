...

{
	...
	if (new_value != selinux_enforcing) {
		#ifndef TCL_TARGET_USER2ROOT	// [FEATURE]-Added by TCTNB(heng.chen),12/30/2015,Task-1241233-ALM
		length = task_has_security(current, SECURITY__SETENFORCE);
		if (length)
			goto out;
		#endif	// [FEATURE]-Added by TCTNB(heng.chen),12/30/2015,Task-1241233-ALM
