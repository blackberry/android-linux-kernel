...
union security_list_options {
	...
	int (*allow_merge_bio)(struct bio *bio1, struct bio *bio2);
...
#ifdef CONFIG_BBRY
	int (*kernel_module_init)(struct module *mod);
	void (*kernel_module_free)(struct module *mod);
#endif
...
#ifdef CONFIG_BBRY
	struct list_head kernel_module_init;
	struct list_head kernel_module_free;
#endif
