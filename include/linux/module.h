...
static inline bool within_module_range(unsigned long addr, void *start, unsigned long size)
{
...
static inline bool within_module_core_rx(unsigned long addr, const struct module *mod)
{
	return within_module_range(addr, mod->module_core_rx, mod->core_size_rx);
}

static inline bool within_module_core_rw(unsigned long addr, const struct module *mod)
{
	return within_module_range(addr, mod->module_core_rw, mod->core_size_rw);
}

static inline bool within_module_init_rx(unsigned long addr, const struct module *mod)
{
	return within_module_range(addr, mod->module_init_rx, mod->init_size_rx);
}

static inline bool within_module_init_rw(unsigned long addr, const struct module *mod)
{
