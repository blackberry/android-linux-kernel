 ...
 *
 * Copyright (C) 2018 Glenn Wurster <gwurster@blackberry.com>
 *
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
...
#ifdef CONFIG_BBSECURE_PROTECTED_VARS_CONST
...
#define update_protected(target, source)						\
	...
	int __update_protected(void *target, void *src, unsigned length);

#else /* CONFIG_BBSECURE_PROTECTED_VARS */

#define __ro_protected
#define update_protected(x, y) x = y

#endif /* CONFIG_BBSECURE_PROTECTED_VARS */
