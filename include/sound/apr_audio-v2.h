...
#define AFE_PORT_ID_SENARY_MI2S_TX_VI		0x1f19
...
#define ADM_CMD_COPP_OPENOPOLOGY_ID_AUDIO_PLAYBACK_WSA_COPP \
								0x00010318
...
/* BlackBerry speaker protection RX module and parameter identifiers */
#define AFE_MODULE_RDA_SPKR_PROT_RX_PROCESS 0x10004101
#define AFE_PARAM_RDA_SPKR_PROT_RX_PROBETONE_RAMP_CONFIG 0x10004112

/* BlackBerry speaker protection V/I module and parameter identifiers */
#define AFE_MODULE_RDA_SPKR_PROT_VI_PROCESS 0x10004102
#define AFE_PARAM_RDA_SPKR_PROT_VI_CALIBRATION_CONFIG 0x10004111

/* R0/T0 calibration configuration */
...
/* Probe tone ramp configuration */
struct rda_spkr_prot_rx_probetone_ramp_config_t {
	int16_t gainStep;
	int16_t gainTarget;
} __packed;

/* Probe tone ramp set param command APR structure */
struct afe_bbry_spkr_prot_rx_probetone_ramp_config_command {
	struct apr_hdr hdr;
	struct afe_port_cmd_set_param_v2 param;
	struct afe_port_param_data_v2 pdata;
	struct rda_spkr_prot_rx_probetone_ramp_config_t config;
} __packed;

/* R0/T0 set param command APR structure */
struct afe_bbry_spkr_prot_set_vi_calibration_command {
	struct apr_hdr hdr;
	struct afe_port_cmd_set_param_v2 param;
	struct afe_port_param_data_v2 pdata;
	struct rda_spkr_prot_vi_calibration_config_t config;
} __packed;

/* R0/T0 get param command APR structure */
...
/* R0/T0 get param command APR response */
