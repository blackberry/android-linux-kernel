...
struct msm_pcm_routing_bdai_data msm_bedais[MSM_BACKEND_DAI_MAX] = {
	...
	{ AFE_PORT_ID_SENARY_MI2S_TX_VI,   0, 0, 0, 0, 0, 0, {0}, LPASS_BE_SENARY_MI2S_TX_VI},
};
...
static const struct snd_kcontrol_new mmul1_mixer_controls[] = {
	...
	SOC_SINGLE_EXT("SEC_MI2S_TX", MSM_BACKEND_DAI_SECONDARY_MI2S_TX,
		MSM_FRONTEND_DAI_MULTIMEDIA1, 1, 0, msm_routing_get_audio_mixer,
		msm_routing_put_audio_mixer),
    SOC_SINGLE_EXT("SENARY_MI2S_TX_VI", MSM_BACKEND_DAI_SENARY_MI2S_TX_VI,
        MSM_FRONTEND_DAI_MULTIMEDIA1, 1, 0, msm_routing_get_audio_mixer,
        msm_routing_put_audio_mixer),
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	*/
	...
	SND_SOC_DAPM_AIF_IN("SENARY_TX", "Senary_mi2s Capture",
				0, 0, 0, 0),
	SND_SOC_DAPM_AIF_IN("SENARY_TX_VI", "Senary_mi2s VI Capture",
				0, 0, 0, 0),
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"MultiMedia1 Mixer", "SENARY_MI2S_TX_VI", "SENARY_TX_VI"},
...
static int msm_routing_get_bbry_spkr_prot_calib(
	struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	...
	/* Invoke helper function in AFE module */
	result = afe_bbry_spkr_prot_get_calibration(
		AFE_PORT_ID_SENARY_MI2S_TX, &calib_data);

	/* Store results */
	ucontrol->value.integer.value[0] = calib_data.R0;
	ucontrol->value.integer.value[1] = calib_data.T0;
	ucontrol->value.integer.value[2] = calib_data.LE;
	ucontrol->value.integer.value[3] = calib_data.valid;
...
static int msm_routing_put_bbry_spkr_prot_calib(
	struct snd_kcontrol *kcontrol,
	struct snd_ctl_elem_value *ucontrol)
{
	struct rda_spkr_prot_vi_calibration_config_t calib_data;
	...
	/* Initialize calibration data structure */
	calib_data.R0 = ucontrol->value.integer.value[0];
	calib_data.T0 = ucontrol->value.integer.value[1];
	calib_data.LE = ucontrol->value.integer.value[2];
	calib_data.valid = ucontrol->value.integer.value[3];
	...
	/* Invoke helper function in AFE module */
	result = afe_bbry_spkr_prot_put_calibration(
		AFE_PORT_ID_SENARY_MI2S_TX, &calib_data);

	return result;
}

/* BlackBerry speaker protection calibration commands */
static const struct snd_kcontrol_new bbry_spkr_prot_calib_controls[] = {
	SOC_SINGLE_MULTI_EXT("BBRY_SPKRPROT_CALIB", SND_SOC_NOPM,
	0, 0xFFFFFFFF, 0, 4,
	msm_routing_get_bbry_spkr_prot_calib,
	msm_routing_put_bbry_spkr_prot_calib),
};
...
#ifdef CONFIG_SND_SOC_BBRY_SPKRPROT
	snd_soc_add_platform_controls(platform,
			bbry_spkr_prot_calib_controls,
			ARRAY_SIZE(bbry_spkr_prot_calib_controls));
#endif /* CONFIG_SND_SOC_BBRY_SPKRPROT */
	return 0;
}
