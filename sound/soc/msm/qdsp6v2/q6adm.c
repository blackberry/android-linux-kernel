	     ...
	     int session_type)
{
	...
	/* MODIFIED-BEGIN by hongwei.tian, 2017-02-08,BUG-4118651*/
	if(topology == ADM_CMD_COPP_OPENOPOLOGY_ID_AUDIO_PLAYBACK_WSA_COPP)
	{
		bit_width = 24;
		pr_err("%s: Force open adm in 24-bit \n ",__func__);
	}
	/* MODIFIED-END by hongwei.tian,BUG-4118651*/
