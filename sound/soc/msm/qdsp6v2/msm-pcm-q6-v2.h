 ...
 * Copyright (c) 2012-2017, 2019, The Linux Foundation. All rights reserved. // MODIFIED by hongwei.tian, 2020-02-17,BUG-8871047
 *
...
struct msm_plat_data {
	int perf_mode;
	struct snd_pcm *pcm;
	struct mutex lock; // MODIFIED by hongwei.tian, 2020-02-17,BUG-8871047
};
