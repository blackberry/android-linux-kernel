...
static int msm8952_wsa_switch_event(struct snd_soc_dapm_widget *w,
			      struct snd_kcontrol *kcontrol, int event);
static bool msm8952_swap_gnd_mic_reset(struct snd_soc_codec *codec); // MODIFIED by hongwei.tian, 2017-06-01,BUG-4881899
		...
		struct msm8916_asoc_mach_data *pdata)
{
	...
	if (pdata->us_euro_gpio < 0) {
		...
		mbhc_cfg.swap_gnd_mic_reset = msm8952_swap_gnd_mic_reset; // MODIFIED by hongwei.tian, 2017-06-01,BUG-4881899
	}

	/* MODIFIED-BEGIN by hongwei.tian, 2017-05-08,BUG-4731384*/
	...
	/* MODIFIED-END by hongwei.tian,BUG-4731384*/
	return 0;
}
...
static int msm8952_get_port_id(int be_id)
{
	...
	case MSM_BACKEND_DAI_SENARY_MI2S_TX_VI:
...
int quat_mi2s_sclk_enable(int enable)
{
	...
	atomic_set(&mmi_calib_state, enable); // Mod by TCTNB.CY
...
#define S(X, Y) ((WCD_MBHC_CAL_PLUG_TYPE_PTR(msm8952_wcd_cal)->X) = (Y))
	...
	S(v_hs_max, 1700); // MODIFIED by hongwei.tian, 2017-07-28,BUG-5040192
#else
	S(v_hs_max, 1600); // MODIFIED by hongwei.tian, 2017-04-28,BUG-4619682
#endif
#undef S
...
#undef S
	...
	btn_low[0] = 75;
	btn_high[0] = 75;
	/* MODIFIED-BEGIN by hongwei.tian, 2017-03-28,BUG-4415936*/
	btn_low[1] = 120;
	btn_high[1] = 120;
	/* MODIFIED-END by hongwei.tian,BUG-4415936*/
	btn_low[2] = 225;
	btn_high[2] = 225;
	btn_low[3] = 450;
	btn_high[3] = 450;
...
static int msm_audrx_init(struct snd_soc_pcm_runtime *rtd)
{
	...
	/* MODIFIED-BEGIN by hongwei.tian, 2017-01-19,BUG-4050200*/
	snd_soc_dapm_ignore_suspend(dapm, "Digital Mic3");
	snd_soc_dapm_ignore_suspend(dapm, "Digital Mic4");
	/* MODIFIED-END by hongwei.tian,BUG-4050200*/
...
static struct snd_soc_dai_link msm8952_dai[] = {
	...
	{/* hw:x,38 */
		.name = LPASS_BE_SENARY_MI2S_TX_VI,
		.stream_name = "Senary_mi2s VI Capture",
		.cpu_dai_name = "msm-dai-q6-mi2s.7",
		.platform_name = "msm-pcm-routing",
		.codec_name = "cajon_codec",
		.codec_dai_name = "cajon_vifeedback",
		.be_id = MSM_BACKEND_DAI_SENARY_MI2S_TX_VI,
		.be_hw_params_fixup = msm_senary_tx_be_hw_params_fixup,
		.ops = &msm8952_mi2s_be_ops,
		.no_pcm = 1,
		.ignore_suspend = 1,
...
/* MODIFIED-BEGIN by hongwei.tian, 2017-07-07,BUG-4981388*/
#ifdef CONFIG_KRYPTON
		.be_hw_params_fixup = msm_tx_be_hw_params_fixup,
#else
		.be_hw_params_fixup = msm_be_hw_params_fixup,
#endif
/* MODIFIED-END by hongwei.tian,BUG-4981388*/
		.ops = &msm8952_quat_mi2s_be_ops,
		.ignore_suspend = 1,
	},
...
static bool msm8952_swap_gnd_mic(struct snd_soc_codec *codec)
{
	...
	pr_err("%s: swap select switch %d to %d\n", __func__, value, !value); // MODIFIED by hongwei.tian, 2017-03-06,BUG-4301452
...
static bool msm8952_swap_gnd_mic_reset(struct snd_soc_codec *codec)
{
	struct snd_soc_card *card = codec->component.card;
	struct msm8916_asoc_mach_data *pdata = snd_soc_card_get_drvdata(card);
	int value, ret;
