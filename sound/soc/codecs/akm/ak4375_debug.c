...
extern void ak4375_reinit(void);
...
static ssize_t ak4375_dac_store(struct device *dev,
        struct device_attribute *attr,
...
static DEVICE_ATTR(ak4375_dac, 0220, NULL, ak4375_dac_store);


static ssize_t ak4375_ldo_store(struct device *dev,
        struct device_attribute *attr,
        const char *buf, size_t count)
{
    int err = 0;
...
static DEVICE_ATTR(ak4375_ldo, 0220, NULL, ak4375_ldo_store);
