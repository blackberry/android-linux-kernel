...
static DEVICE_ATTR(spk_box_type, 0664, tfa9890_spkbox_show, tfa9890_spkbox_store);
...
static DEVICE_ATTR(tfa9890_reset, 0664, tfa9890_reset_show, tfa9890_reset_store);
...
static DEVICE_ATTR(tfa9890_switch1, 0664, tfa9890_switch1_show, tfa9890_switch1_store);
...
static DEVICE_ATTR(tfa9890_switch2, 0664, tfa9890_switch2_show, tfa9890_switch2_store);
...
extern int sec_mi2s_sclk_enable(int enable);
...
static ssize_t tfa9890_sclk_store(struct device *dev, struct device_attribute *attr, const char *buf, size_t size)
{
    ...
    sec_mi2s_sclk_enable((int)value);
    /*End Kun.Guan & Xing.Wang modify quat i2s sclk protection, 2015-09-01*/

    return size;
}
static DEVICE_ATTR(sclk, 0664, tfa9890_sclk_show, tfa9890_sclk_store);
...
static DEVICE_ATTR(calibrate, 0664, tfa9890_calibrate_show, tfa9890_calibrate_store);
