...
extern int mb_2p7v_flg; // MODIFIED by hongwei.tian, 2017-06-02,BUG-4883765
			...
			struct wcd9xxx_micbias_setting *micbias)
{
	...
	if (ret) {
		dev_dbg(dev, "Looking up %s property in node %s failed",
			prop_name, dev->of_node->full_name);
/* MODIFIED-BEGIN by hongwei.tian, 2017-07-04,BUG-4841746*/
#if defined(CONFIG_KRYPTON)
			micbias->cfilt1_mv = 2700000;
			mb_2p7v_flg = 1;
#else
/* MODIFIED-END by hongwei.tian,BUG-4841746*/
		if(get_board_version()==BOARD_PIO05)
		/* MODIFIED-BEGIN by hongwei.tian, 2017-06-02,BUG-4883765*/
		{
			micbias->cfilt1_mv = 2700000;
			mb_2p7v_flg = 1;
		}
		/* MODIFIED-END by hongwei.tian,BUG-4883765*/
		else
			micbias->cfilt1_mv = MICBIAS_DEFAULT_VAL;
#endif // MODIFIED by hongwei.tian, 2017-07-04,BUG-4841746
	}
}
