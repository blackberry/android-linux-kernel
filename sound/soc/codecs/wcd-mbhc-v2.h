...
struct wcd_mbhc {
	...
	unsigned long time_after_hph_report_xs;// haitao.yin add this change to avoid btn event reported when headset inserting or removing, 20160924
