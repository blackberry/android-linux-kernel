...
struct wcd_mbhc_config {
	...
	bool (*swap_gnd_mic_reset)(struct snd_soc_codec *codec); // MODIFIED by hongwei.tian, 2017-06-01,BUG-4881899
	bool hs_ext_micbias;
	bool gnd_det_en;
...
struct wcd_mbhc {
	...
	bool is_selfie_stick_insert; // MODIFIED by hongwei.tian, 2017-06-01,BUG-4881899
};
