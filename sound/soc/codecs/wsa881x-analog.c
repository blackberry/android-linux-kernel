...
#if defined(CONFIG_BBRY) || defined(CONFIG_BBRY_MINISW)
static const char * const wsa881x_spk_pa_gain_text[] = {
"POS_18_DB", "POS_16P5_DB", "POS_15_DB", "POS_13P5_DB", "POS_12_DB",
"POS_10P5_DB", "POS_9_DB", "POS_7P5_DB", "POS_6_DB", "POS_4P5_DB",
"POS_3_DB", "POS_1P5_DB", "POS_0_DB"};
#else
static const char * const wsa881x_spk_pa_gain_text[] = {
"POS_13P5_DB", "POS_12_DB", "POS_10P5_DB", "POS_9_DB", "POS_7P5_DB",
"POS_6_DB", "POS_4P5_DB", "POS_3_DB", "POS_1P5_DB", "POS_0_DB"};
#endif /* defined(CONFIG_BBRY) || defined(CONFIG_BBRY_MINISW) */
...
static int wsa881x_boost_ctrl(struct snd_soc_codec *codec, bool enable)
{
	...
	if (enable) {
		if (!WSA881X_IS_2_0(wsa881x->version)) {
			...
			snd_soc_update_bits(codec, WSA881X_BOOST_PRESET_OUT1,
							0xF0, 0x70);
			snd_soc_update_bits(codec, WSA881X_ANA_CTL, 0x03, 0x03);// MODIFIED by hongwei.tian, 2017-02-08,BUG-4118651
