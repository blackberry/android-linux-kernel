 ...
 * It is the responsibility of the caller to free the returned packet_fanout // MODIFIED by liping-yuan, 2018-07-12,BUG-6554478
			  ...
			  __be16 proto)
{
	...
	/* MODIFIED-BEGIN by liping-yuan, 2018-07-12,BUG-6554478*/
	if (po->fanout) {
		ret = -EINVAL;
		goto out_unlock;
	}
	/* MODIFIED-END by liping-yuan,BUG-6554478*/
