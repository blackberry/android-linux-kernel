				...
				enum pm_qos_req_action action, int value)
{
	...
	if (value == 26) {
		WARN(1, KERN_ERR "==========pm_qos_update_target here!!!\n");
		dump_stack();
	}
...
{
	if (value == (s32)26) {
		WARN(1, KERN_ERR "==========pm_qos_add_request here!!!!\n");
		dump_stack();
	}
...
{
	if (new_value == (s32)26) {
		WARN(1, KERN_ERR "==========pm_qos_update_request here!!!\n");
		dump_stack();
	}
...
{
	if (new_value == (s32)26) {
		WARN(1, KERN_ERR "==========pm_qos_update_request_timeout here!!!\n");
		dump_stack();
	}
