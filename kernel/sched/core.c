...
static void remove_task_from_group(struct task_struct *p)
{
	...
	list_del_init(&p->grp_list);
        //huaidi.feng 93183 2016.3.28 modify begin for DEFECT 1839529 according to Qualcomm CR985379
	//p->grp = NULL;
        rcu_assign_pointer(p->grp, NULL);
        //huaidi.feng 93183 modify end
	__task_rq_unlock(rq);
...
try_to_wake_up(struct task_struct *p, unsigned int state, int wake_flags)
{
	...
	//grp = task_related_thread_group(p); //huaidi.feng 93183 2016.3.28 deleted for DEFECT 1839529 according to Qualcomm CR985379
	wallclock = sched_ktime_clock();
	update_task_ravg(rq->curr, rq, TASK_UPDATE, wallclock, 0);
...
void scheduler_tick(void)
{
	...
	//grp = task_related_thread_group(curr); //huaidi.feng 93183 2016.3.28 deleted  for DEFECT 1839529 according to Qualcomm CR985379
	set_window_start(rq);
	update_rq_clock(rq);
