...
static struct ctl_table kern_table[] = {
...
#ifdef CONFIG_MODULE_MODPROBE
	{
		.procname	= "modprobe",
		.data		= &modprobe_path,
		.maxlen		= KMOD_PATH_LEN,
#ifdef CONFIG_MODULE_MODPROBE_WRITABLE
		.mode		= 0644,
#else
		.mode		= 0444,
#endif
...
#ifdef CONFIG_UEVENT_HELPER_DISABLED
		.mode		= 0444,
#else
		.mode		= 0644,
#endif
...
#if defined(CONFIG_MMU)
	{
		...
		.maxlen		= sizeof(int),
#ifdef CONFIG_HEAP_RAND_PROCFS_DISABLED
		.mode		= 0444,
#else
		.mode		= 0644,
#endif
...
#endif
#ifdef CONFIG_POWEROFF_CMD
	{
		.procname	= "poweroff_cmd",
		.data		= &poweroff_cmd,
		.maxlen		= POWEROFF_CMD_PATH_LEN,
#ifdef CONFIG_POWEROFF_CMD_WRITABLE
		.mode		= 0644,
#else
		.mode           = 0444,
#endif
...
static struct ctl_table vm_table[] = {
...
#ifdef CONFIG_MMU
	{
		...
		.maxlen		= sizeof(unsigned long),
#ifdef CONFIG_MMAP_MIN_ADDR_DISABLED
		.mode		= 0444,
#else
		.mode		= 0644,
#endif
